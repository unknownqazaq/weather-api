...
func (c *WeatherClient) GetCityCoordinates(ctx context.Context, city, country string) (*ProviderCity, error) {
...
func (c *WeatherClient) GetCitiesByCountry(ctx context.Context, country string, limit int) ([]ProviderCity, error) {
	if limit <= 0 {
		limit = 10
	}
	...
	cities := make([]ProviderCity, 0, limit)
